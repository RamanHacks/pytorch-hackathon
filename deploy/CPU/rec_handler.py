...
class RecHandler(BaseHandler):
    ...
    def initialize(self, context):
        ...
        config = {"job_name": "rec_infer", "level": "INFO", "batch_size": 8, "device": "cpu", "lang": "ch_sim", "max_text_length": 25, "use_space_char": True, "whitelist": None, "blacklist": None, "input": "test/", "model_location": "/home/fsmlp/Desktop/MyRepo/UCR/models/rec/ch_PP-OCRv2_rec_train.pt", "font_path": None, "char_dict_location": ucr.__file__.replace('__init__.py', '') + 'utils/dict/ch_sim_dict.txt', "Preprocess": [{"RecResizeImg": {"image_shape": [3, 32, 100]}}], "Architecture": {"model_type": "rec", "algorithm": "CRNN", "Transform": None, "Backbone": {"name": "MobileNetV1Enhance", "scale": 0.5}, "Neck": {"name": "SequenceEncoder", "encoder_type": "rnn", "hidden_size": 64}, "Head": {"name": "CTCHead", "mid_channels": 96, "fc_decay": 2e-05}}, "Postprocess": {"name": "CTCLabelDecode"}}
            ...
            if oldidx != newidx:
                ...
                if rec_result[rno][0] != '':
                    rec_res = [{
                        ...
                        'ocr': [rec_result[rno][0], str(rec_result[rno][1])],
                        'key': ['#other', 1]
                        }]
                else:
                    rec_res = []
