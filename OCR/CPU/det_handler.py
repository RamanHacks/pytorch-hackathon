...
class DetectionHandler(BaseHandler):
    ...
    def initialize(self, context):
        ...
        # config = {"job_name": "det_infer", "level": "INFO", "batch_size": 1, "device": "cpu", "input": "test/", "output": "test_output/", "model_location": "/home/fsmlp/Desktop/MyRepo/UCR/models/det/ch_PP-OCRv2_det_distill_train.pt", "Preprocess": [{"DetResizeForTest": {"limit_side_len": 960, "limit_type": "max"}}, {"NormalizeImage": {"scale": "1./255.", "mean": [0.485, 0.456, 0.406], "std": [0.229, 0.224, 0.225], "order": "hwc"}}, {"ToCHWImage": None}, {"KeepKeys": {"keep_keys": ["image", "shape"]}}], "Architecture": {"model_type": "det", "algorithm": "DB", "Transform": None, "Backbone": {"name": "MobileNetV3", "scale": 0.5, "model_name": "large", "disable_se": True}, "Neck": {"name": "DBFPN", "out_channels": 96}, "Head": {"name": "DBHead", "k": 50}}, "Postprocess": {"name": "DBPostProcess", "thresh": 0.3, "box_thresh": 0.6, "max_candidates": 1000, "unclip_ratio": 1.5, "use_dilation": False}}
        config = {"job_name": "det_infer", "level": "INFO", "batch_size": 4, "device": "cpu", "input": "test/", "output": "test_output/", "model_location": "/home/fsmlp/Desktop/MyRepo/UCR/models/det/ch_PP-OCRv2_det_distill_train.pt", "Preprocess": [{"DetResizeForTest": {"image_shape": (960,736)}}, {"NormalizeImage": {"scale": "1./255.", "mean": [0.485, 0.456, 0.406], "std": [0.229, 0.224, 0.225], "order": "hwc"}}, {"ToCHWImage": None}, {"KeepKeys": {"keep_keys": ["image", "shape"]}}], "Architecture": {"model_type": "det", "algorithm": "DB", "Transform": None, "Backbone": {"name": "MobileNetV3", "scale": 0.5, "model_name": "large", "disable_se": True}, "Neck": {"name": "DBFPN", "out_channels": 96}, "Head": {"name": "DBHead", "k": 50}}, "Postprocess": {"name": "DBPostProcess", "thresh": 0.3, "box_thresh": 0.6, "max_candidates": 1000, "unclip_ratio": 1.5, "use_dilation": False}}
    ...
    def postprocess(self, data, shape_list, img_shapes):         
        ...
        for i,out in enumerate(data):            
            preds={}
            preds["maps"] = np.expand_dims(out, axis=0)
    ...
    def handle(self, data, context):
        ...
        model_output = self.inference(images)["maps"].cpu().numpy()
